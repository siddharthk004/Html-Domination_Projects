...
const EditProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const userData = {
      email: email || null, // Ensure email is included
  ...
  return (
    <div>
      ...
      <div className="bg-green-300 w-full h-[95vh] pt-4 pl-[50vh] m-auto bg-gradient-to-l from-green-300 via-white to-orange-300">
        <div className="bg-blue-100 h-[82%] w-[70%] border-2 border-gray-300 rounded-3xl shadow-2xl shadow-zinc-600">
          <h1 className="text-4xl text-center font-bold mb-2 mt-2">
            Edit Profile
          </h1>

          <form onSubmit={handleSubmit}>
          <div className="pl-12 w-[75%] mt-5 flex gap-32">
              <h1 className="text-2xl mt-6 font-semibold">Email </h1>
              <input
                type="email"
                value={email}
            ...
            <div className="pl-12 w-[75%] mt-5 flex gap-20">
              ...
              <input
                ...
                placeholder="length should more than 5"
                className="w-2/3 px-6 py-4 mt-3 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring focus:ring-blue-400"
              />
            </div>
            <div className="pl-12 w-[75%] mt-5 flex gap-20">
