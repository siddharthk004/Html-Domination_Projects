  ...
  return (
    <div className="p-2 pt-5 pl-5">
      <div className="h-[35vh] w-[26vh] bg-green-100 rounded-3xl border border-green-400 shadow-2xl">
        ...
        <h1 className="text-xl m-2 font-semibold leading-none text-center">{data.name}</h1>
        <h1 className="text-sm text-center leading-none">{data.companyName}</h1>
        <h1 className="text-lg  mb-2 ml-20 font-bold text-green-700">
          {data.DiscountTprice} RS<s className="ml-3 text-sm text-black">{data.TotalPrice}Rs</s>
        </h1>
